...
Bem-vindo à documentação oficial do projeto **br-counties**. Esta Wiki atua como um atlas aberto e enciclopédia de inteligência territorial, estruturando o território brasileiro a partir do conceito de **Condados**.
...
Para mapear essas interações, o Instituto Brasileiro de Geografia e Estatística (IBGE) estabeleceu a divisão regional por **Regiões Geográficas Imediatas (RGIs)**. No projeto `br-counties`, cada RGI é modelada e analisada como um **Condado**, permitindo uma leitura mais precisa da organização do espaço e do planejamento regional.
